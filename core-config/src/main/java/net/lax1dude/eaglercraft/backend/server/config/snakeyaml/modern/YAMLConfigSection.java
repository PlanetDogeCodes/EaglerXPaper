...
import net.lax1dude.eaglercraft.backend.server.config.snakeyaml.modern.YAMLConfigList;
import net.lax1dude.eaglercraft.backend.server.config.snakeyaml.modern.YAMLConfigLoader;
...
implements IEaglerConfSection {
    ...
    protected YAMLConfigSection(YAMLConfigBase owner, MappingNode yaml, Consumer<String> commentSetter, boolean exists) {
        this.owner = owner;
        this.yaml = yaml;
    ...
    public IEaglerConfSection getIfSection(String name) {
        ...
        if (t != null && t.getValueNode() != null && t.getValueNode() instanceof MappingNode) {
            ...
            return new YAMLConfigSection(this.owner, value2, comment -> {
    ...
    public IEaglerConfSection getSection(String name) {
        ...
        ScalarNode key = new ScalarNode(Tag.STR, name, null, null, DumperOptions.ScalarStyle.PLAIN);
        ...
        return new YAMLConfigSection(this.owner, obj, comment -> {
    ...
    public IEaglerConfList getIfList(String name) {
        ...
        if (t != null && t.getValueNode() != null && t.getValueNode() instanceof SequenceNode) {
            ...
            return new YAMLConfigList(this.owner, value2, comment -> {
                YAMLConfigLoader.createCommentHelper(comment, (ScalarNode)t.getKeyNode());
                this.owner.modified = true;
            }, true);
        }
    ...
    public IEaglerConfList getList(String name) {
        ...
        this.owner.modified = true;
        this.initialized = true;
        return new YAMLConfigList(this.owner, obj, comment -> {
            YAMLConfigLoader.createCommentHelper(comment, key);
            this.owner.modified = true;
        }, false);
    }
    ...
    public boolean getBoolean(String name, boolean defaultValue, String comment) {
        ...
        ScalarNode key = new ScalarNode(Tag.STR, name, null, null, DumperOptions.ScalarStyle.PLAIN);
        if (comment != null) {
            ArrayList<CommentLine> lst = new ArrayList<CommentLine>();
            YAMLConfigLoader.createComment(comment, lst);
            key.setBlockComments(lst);
        }
        ScalarNode node = new ScalarNode(Tag.BOOL, Boolean.toString(defaultValue), null, null, DumperOptions.ScalarStyle.PLAIN);
    ...
    public boolean getBoolean(String name, Supplier<Boolean> defaultValue, String comment) {
        ...
        ScalarNode node = new ScalarNode(Tag.BOOL, Boolean.toString(b), null, null, DumperOptions.ScalarStyle.PLAIN);
        t = new NodeTuple((Node)key, (Node)node);
        this.accelerator.put(name, t);
        this.yaml.getValue().add(t);
        this.owner.modified = true;
    ...
    public int getInteger(String name, int defaultValue, String comment) {
        ...
        ScalarNode node = new ScalarNode(Tag.INT, Integer.toString(defaultValue), null, null, DumperOptions.ScalarStyle.PLAIN);
        t = new NodeTuple((Node)key, (Node)node);
        this.accelerator.put(name, t);
        this.yaml.getValue().add(t);
        this.owner.modified = true;
    ...
    public int getInteger(String name, Supplier<Integer> defaultValue, String comment) {
        ...
        ScalarNode node = new ScalarNode(Tag.INT, Integer.toString(i), null, null, DumperOptions.ScalarStyle.PLAIN);
        t = new NodeTuple((Node)key, (Node)node);
        this.accelerator.put(name, t);
        this.yaml.getValue().add(t);
        this.owner.modified = true;
    ...
    public String getString(String name, String defaultValue, String comment) {
        ...
        ScalarNode node = new ScalarNode(Tag.STR, defaultValue, null, null, DumperOptions.ScalarStyle.SINGLE_QUOTED);
        t = new NodeTuple((Node)key, (Node)node);
        this.accelerator.put(name, t);
        this.yaml.getValue().add(t);
        this.owner.modified = true;
    ...
    public String getString(String name, Supplier<String> defaultValue, String comment) {
        ...
        ScalarNode node = new ScalarNode(Tag.STR, str, null, null, DumperOptions.ScalarStyle.SINGLE_QUOTED);
        t = new NodeTuple((Node)key, (Node)node);
        this.accelerator.put(name, t);
        this.yaml.getValue().add(t);
        this.owner.modified = true;
